...
export const metadata: Metadata = {
  ...
  description:
    "TALOS（タロス）ワンウェイケグは使い捨てタイプのビールケグです。ステンレスケグと比較して運用コスト削減、軽量設計（1.3kg）で輸送費削減を実現。S/A/G/Tタイプ対応で既存設備利用可能。海外展開・小規模ブルワリー向け。",
  ...
  openGraph: {
    ...
    // OG説明文を200文字以内で最適化
    description:
      "TALOS（タロス）ワンウェイケグなら運用コスト削減！軽量1.3kgで輸送費も削減。ステンレスケグの回収・洗浄・メンテナンス不要。S/A/G/Tタイプ対応で既存設備そのまま利用可能。海外展開・小規模ブルワリーに最適なソリューションです。",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "TALOS（タロス）ワンウェイケグ - 運用コスト削減の使い捨てビールケグ",
  ...
  twitter: {
    ...
    title: "TALOS ワンウェイケグ｜運用コスト削減",

    // Twitter説明文を200文字以内で最適化
    description:
      "軽量1.3kgの使い捨てビールケグでコスト革命！ステンレスケグと比較して運用コスト削減。回収・洗浄・メンテナンス不要。S/A/G/Tタイプ対応で既存設備利用可能。海外展開・小規模ブルワリーの課題を解決します。",
